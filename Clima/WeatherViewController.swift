...
class WeatherViewController: UIViewController ,CLLocationManagerDelegate,ChangeCityName{
    ...
    let APP_ID = "37ec227bfe055c93afcd922281c0da70"
    ...
    func updateWeatherData(json:JSON){
        if let tempVal = json["main"]["temp"].double{    //get current temperature
        weatherDataModel.temperature=Int(tempVal-273.15)
